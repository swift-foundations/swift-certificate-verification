...
extension Certificate.Extension {
  ...
  public init(_ keyUsage: KeyUsage, critical: Bool) throws {
    ...
    self.init(
      oid: .X509ExtensionID.keyUsage, critical: critical, value: serializer.serializedBytes[...])
  }
}
...
extension ISO_8824.BitString {
  ...
  package init(_ ext: KeyUsage) {
    if ext.decipherOnly {
      ...
      let bytes = [
        UInt8(truncatingIfNeeded: ext.rawValue >> 8), UInt8(truncatingIfNeeded: ext.rawValue),
      ]
