...
public struct NameConstraints {
  ...
  public init(_ ext: Certificate.Extension) throws {
    ...
    guard
      nameConstraintsValue.permittedSubtrees != nil || nameConstraintsValue.excludedSubtrees != nil
    else {
...
extension Certificate.Extension {
  ...
  public init(_ nameConstraints: NameConstraints, critical: Bool) throws {
    ...
    self.init(
      oid: .X509ExtensionID.nameConstraints, critical: critical,
...
struct GeneralSubtrees: ISO_8825.DER.ImplicitlyTaggable, Sendable {
    ...
    throws(ISO_8824.Error)
  {
    self.base = try ISO_8825.DER.sequence(rootNode, identifier: identifier) {
      (nodes: inout ISO_8825.Node.Collection.Iterator) throws(ISO_8824.Error) -> [GeneralName] in
