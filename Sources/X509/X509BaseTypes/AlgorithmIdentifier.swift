...
@usableFromInline
package struct AlgorithmIdentifier: ISO_8825.DER.ImplicitlyTaggable, ISO_8825.BER
    .ImplicitlyTaggable,
  Hashable, Sendable
{
  @inlinable
    ...
    throws(ISO_8824.Error)
  {
    ...
    self = try ISO_8825.DER.sequence(rootNode, identifier: identifier) {
      (nodes: inout ISO_8825.Node.Collection.Iterator) throws(ISO_8824.Error) -> AlgorithmIdentifier
      in
  ...
  @inlinable
  package init(berEncoded rootNode: ISO_8825.Node, withIdentifier identifier: ISO_8824.Identifier)
    throws(ISO_8824.Error)
  {
