...
@Suite struct `IPAddress Tests` {
  static let fixtures: [(ISO_8824.OctetString, ISO_8824.OctetString, Bool)] = [
    ...
    (
      .v6("fe80::8d:f7d:79c5:5719"), .v6(subnet: "fe80::8d:f7d:79c5:5719", mask: "::ffff:ffff"),
      false
    ),
    (
      .v6("fe80::8d:f7d:79c5:5719"), .v6(subnet: "fe80::8d:f7d:79c5:5719", mask: "ffff::ffff"),
    ...
    (
      .v6("fe80::8d:f7d:79c5:5719"), .v6(subnet: "fe81::8d:f7d:79c5:5719", mask: "ffff:ffff::"),
      false
    ),
    ...
    (
      .v4("17.250.78.1"), ISO_8824.OctetString(contentBytes: .init(repeating: 0xff, count: 1)),
      false
    ),
    (
      .v4("17.250.78.1"), ISO_8824.OctetString(contentBytes: .init(repeating: 0xff, count: 7)),
      false
    ),
    (
      .v4("17.250.78.1"), ISO_8824.OctetString(contentBytes: .init(repeating: 0xff, count: 9)),
      false
    ),
    (
      .v6("fe80::8d:f7d:79c5:5719"),
    ...
    for (presentedName, constraint, match) in Self.fixtures {
      #expect(
        NameConstraintsPolicy.ipAddressMatchesConstraint(
          ipAddress: presentedName, constraint: constraint)
          == match
      )
    }
  }
