...
extension RFC5280Policy.Test.Deprecated.Unit {
    ...
    func `ignores key usage`() async throws {
        ...
        #expect(chain == [leaf, alternativeIntermediate, TestPKI.unconstrainedCA])
    }
}

extension RFC5280Policy.Test.Deprecated.`Edge Case` {
    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `valid v1 certs with extensions are rejected`() async throws {
        let roots = CertificateStore([TestPKI.unconstrainedCA])
    ...
    @Test
    func `expired leaf is rejected`() async throws {
        try await Deprecated._expiredLeafIsRejected(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `expired leaf is rejected base policy`() async throws {
        try await Deprecated._expiredLeafIsRejected(.expiry)
    }
    ...
    @Test
    func `expired intermediate is rejected`() async throws {
        try await Deprecated._expiredIntermediateIsRejected(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `expired intermediate is rejected base policy`() async throws {
        try await Deprecated._expiredIntermediateIsRejected(.expiry)
    }
    ...
    @Test
    func `expired root is rejected`() async throws {
        try await Deprecated._expiredRootIsRejected(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `expired root is rejected base policy`() async throws {
        try await Deprecated._expiredRootIsRejected(.expiry)
    }
    ...
    @Test
    func `not yet valid leaf is rejected`() async throws {
        try await Deprecated._notYetValidLeafIsRejected(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `not yet valid leaf is rejected base policy`() async throws {
        try await Deprecated._notYetValidLeafIsRejected(.expiry)
    }
    ...
    @Test
    func `not yet valid intermediate is rejected`() async throws {
        try await Deprecated._notYetValidIntermediateIsRejected(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `not yet valid intermediate is rejected base policy`() async throws {
        try await Deprecated._notYetValidIntermediateIsRejected(.expiry)
    }
    ...
    @Test
    func `not yet valid root is rejected`() async throws {
        try await Deprecated._notYetValidRootIsRejected(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `not yet valid root is rejected base policy`() async throws {
        try await Deprecated._notYetValidRootIsRejected(.expiry)
    }
    ...
    @Test
    func `malformed expiry is rejected`() async throws {
        try await Deprecated._malformedExpiryIsRejected(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `malformed expiry is rejected base policy`() async throws {
        try await Deprecated._malformedExpiryIsRejected(.expiry)
    }
    ...
    @Test
    func `self signed certs must be marked as ca`() async throws {
        try await Deprecated._selfSignedCertsMustBeMarkedAsCA(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `self signed certs must be marked as ca base policy`() async throws {
        try await Deprecated._selfSignedCertsMustBeMarkedAsCA(.basicConstraints)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `intermediate ca must be marked as ca in basic constraints`() async throws {
        try await Deprecated._intermediateCAMustBeMarkedCAInBasicConstraints(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `intermediate ca must be marked as ca in basic constraints base policy`() async throws {
        try await Deprecated._intermediateCAMustBeMarkedCAInBasicConstraints(.basicConstraints)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `root ca must be marked as ca in basic constraints`() async throws {
        try await Deprecated._rootCAMustBeMarkedCAInBasicConstraints(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `root ca must be marked as ca in basic constraints base policy`() async throws {
        try await Deprecated._rootCAMustBeMarkedCAInBasicConstraints(.basicConstraints)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `path length constraints from intermediates are applied`() async throws {
        try await Deprecated._pathLengthConstraintsFromIntermediatesAreApplied(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `path length constraints from intermediates are applied base policy`() async throws {
        try await Deprecated._pathLengthConstraintsFromIntermediatesAreApplied(.basicConstraints)
    }
    ...
    @Test
    func `path length constraints does only count non self issued certificates`() async throws {
        try await Deprecated._pathLengthConstraintsDoesOnlyCountNonSelfIssuedCertificates(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `path length constraints does only count non self issued certificates base policy`() async throws {
        try await Deprecated._pathLengthConstraintsDoesOnlyCountNonSelfIssuedCertificates(.basicConstraints)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `subtrees of unknown type always fail`() async throws {
        try await Deprecated.subtreesOfUnknownTypeAlwaysFail(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `subtrees of unknown type always fail base policy`() async throws {
        try await Deprecated.subtreesOfUnknownTypeAlwaysFail(.nameConstraints)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `broken extensions prevent validation`() async throws {
        try await Deprecated.brokenExtensionsPreventValidation(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `broken extensions prevent validation base policy`() async throws {
        try await Deprecated.brokenExtensionsPreventValidation(.nameConstraints)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `excluded subtrees beat permitted subtrees`() async throws {
        try await Deprecated.excludedSubtreesBeatPermittedSubtrees(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `excluded subtrees beat permitted subtrees base policy`() async throws {
        try await Deprecated.excludedSubtreesBeatPermittedSubtrees(.nameConstraints)
    }
...
extension RFC5280Policy.Test.Deprecated.Integration {
    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `valid certs are accepted`() async throws {
        let roots = CertificateStore([TestPKI.unconstrainedCA])
        ...
        #expect(chain == [leaf, TestPKI.unconstrainedIntermediate, TestPKI.unconstrainedCA])
    }
    ...
    func `dns name constraints excluded subtrees`() async throws {
        for (dnsName, constraint, match) in DNSNamesTests.fixtures {
            try await Deprecated.nameconstraintsExcludedSubtrees(
                excludedSubtrees: [.dnsName(constraint)],
                subjectAlternativeNames: [.dnsName(dnsName)],
                match: match,
                policyFactory: .rfc5280
    ...
    func `dns name constraints permitted subtrees`() async throws {
        for (dnsName, constraint, match) in DNSNamesTests.fixtures {
            try await Deprecated.nameconstraintsPermittedSubtrees(
                permittedSubtrees: [.dnsName(constraint)],
                subjectAlternativeNames: [.dnsName(dnsName)],
                match: match,
                policyFactory: .rfc5280
    ...
    @Test
    func `all excluded subtrees are evaluated`() async throws {
        try await Deprecated.allExcludedSubtreesAreEvaluated(.rfc5280)
    }

    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    @Test
    func `all excluded subtrees are evaluated base policy`() async throws {
        try await Deprecated.allExcludedSubtreesAreEvaluated(.nameConstraints)
    }
...
extension RFC5280Policy.Test.Deprecated {
    @available(*, deprecated, message: "deprecated because it uses deprecated API")
    enum PolicyFactory {
        case rfc5280
        case expiry
    ...
    static func nameconstraintsExcludedSubtrees(
        ...
        #expect(chain == [leaf, intermediateWithAConstrainedNameForSomeReason, TestPKI.unconstrainedCA])
    }
    ...
    static func _intermediateCAMustBeMarkedCAInBasicConstraints(_ policyFactory: PolicyFactory) async throws {
        ...
        for badIntermediate in invalidIntermediateCAs {
            ...
            #expect(chain == [leaf, v1Intermediate, TestPKI.unconstrainedCA])
        }
    }
    ...
    static func _rootCAMustBeMarkedCAInBasicConstraints(_ policyFactory: PolicyFactory) async throws {
        ...
        for badRoot in invalidRootCAs {
            ...
            #expect(chain == [leaf, TestPKI.unconstrainedIntermediate, v1Root])
        }
    }
    ...
    static func _pathLengthConstraintsFromIntermediatesAreApplied(_ policyFactory: PolicyFactory) async throws {
        ...
        #expect(chain == [leaf, secondLevelIntermediate, newFirstLevelIntermediate, TestPKI.unconstrainedCA])
    }
    ...
    static func _pathLengthConstraintsDoesOnlyCountNonSelfIssuedCertificates(
        ...
        #expect(chain == [leaf, intermediate, alternativeRoot])
    }
