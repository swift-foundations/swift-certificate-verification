...
extension Certificate.Signature.Test.Unit {
  @Test
  func `ed25519 signature bytes match raw representation`() throws {
    let input = Array("Hello World".utf8)

    let expected = try Fixtures.ed25519Key.signature(for: input)
    let signature = try Certificate.Signature(
      signatureAlgorithm: .ed25519,
      signatureBytes: .init(bytes: Array(expected)[...])
    )

    #expect(.init(expected) == signature.rawRepresentation)
  }

  @Test
  func `ecdsa signature bytes match raw representation`() throws {
    let input = Array("Hello World".utf8)

    let expected = try Fixtures.p384Key.signature(for: SHA256.hash(data: input))
    let signature = try Certificate.Signature(
      signatureAlgorithm: .ecdsaWithSHA256,
      signatureBytes: .init(bytes: Array(expected.derRepresentation)[...])
    )

    #expect(.init(expected.derRepresentation) == signature.rawRepresentation)
  }
  ...
  @Test
  func `signature algorithm initialized with rfc8446 value`() {
    let supportedValues = Set(Fixtures.supportedRFC8446SignatureAlgorithms.keys)
    for value in 0...UInt16.max {
      if supportedValues.contains(value) {
        let algo = Certificate.SignatureAlgorithm(rfc8446SignatureSchemeValue: value)
        #expect(algo != nil)
        #expect(algo == Fixtures.supportedRFC8446SignatureAlgorithms[value])
      } else {
        #expect(Certificate.SignatureAlgorithm(rfc8446SignatureSchemeValue: value) == nil)
      }
    }
  ...
  @Test
  func `map private key to supported signature algorithm ecdsa`() throws {
    #expect(
      Set(Certificate.PrivateKey(Fixtures.p256Key).supportedSignatureAlgorithms)
        == Set([.ecdsaWithSHA256, .ecdsaWithSHA384, .ecdsaWithSHA512])
    )
    #expect(
      Set(Certificate.PrivateKey(Fixtures.p384Key).supportedSignatureAlgorithms)
        == Set([.ecdsaWithSHA256, .ecdsaWithSHA384, .ecdsaWithSHA512])
    )
    #expect(
      Set(Certificate.PrivateKey(Fixtures.p521Key).supportedSignatureAlgorithms)
        == Set([.ecdsaWithSHA256, .ecdsaWithSHA384, .ecdsaWithSHA512])
    )
  }

  @Test
  func `map private key to supported signature algorithm eddsa`() throws {
    #expect(
      Set(Certificate.PrivateKey(Fixtures.ed25519Key).supportedSignatureAlgorithms)
        == Set([.ed25519]))
  }
}
...
extension Certificate.Signature.Test.`Edge Case` {
  ...
  private func hashFunctionMismatchTest(
    ...
    do {
      let certificate = try Certificate(
        ...
        notValidBefore: Fixtures.now,
        notValidAfter: Fixtures.oneYearFromNow,
        issuer: name,
        subject: name,
      ...
      #expect(
        !validCombination, "Unable to create cert combining \(privateKey) and \(signatureAlgorithm)"
      )
    }
  }
  ...
  @Test
  func `hash function mismatch p256 ecdsa with sha256`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p256Key),
      signatureAlgorithm: .ecdsaWithSHA256,
  ...
  @Test
  func `hash function mismatch p256 ecdsa with sha384`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p256Key),
  ...
  @Test
  func `hash function mismatch p256 ecdsa with sha512`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p256Key),
  ...
  @Test
  func `hash function mismatch p256 sha1 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p256Key),
  ...
  @Test
  func `hash function mismatch p256 sha256 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p256Key),
  ...
  @Test
  func `hash function mismatch p256 sha384 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p256Key),
  ...
  @Test
  func `hash function mismatch p256 sha512 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p256Key),
  ...
  @Test
  func `hash function mismatch p256 ed25519`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p256Key),
      signatureAlgorithm: .ed25519,
      validCombination: false
  ...
  @Test
  func `hash function mismatch p384 ecdsa with sha256`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p384Key),
      signatureAlgorithm: .ecdsaWithSHA256,
      validCombination: true
    )
  }
  ...
  @Test
  func `hash function mismatch p384 ecdsa with sha384`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p384Key),
      signatureAlgorithm: .ecdsaWithSHA384,
      validCombination: true
  ...
  @Test
  func `hash function mismatch p384 ecdsa with sha512`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p384Key),
      signatureAlgorithm: .ecdsaWithSHA512,
      validCombination: true
  ...
  @Test
  func `hash function mismatch p384 sha1 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p384Key),
      signatureAlgorithm: .sha1WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch p384 sha256 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p384Key),
      signatureAlgorithm: .sha256WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch p384 sha384 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p384Key),
      signatureAlgorithm: .sha384WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch p384 sha512 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p384Key),
      signatureAlgorithm: .sha512WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch p384 ed25519`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p384Key),
      signatureAlgorithm: .ed25519,
      validCombination: false
  ...
  @Test
  func `hash function mismatch p521 ecdsa with sha256`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p521Key),
      signatureAlgorithm: .ecdsaWithSHA256,
      validCombination: true
    )
  }
  ...
  @Test
  func `hash function mismatch p521 ecdsa with sha384`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p521Key),
      signatureAlgorithm: .ecdsaWithSHA384,
      validCombination: true
  ...
  @Test
  func `hash function mismatch p521 ecdsa with sha512`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p521Key),
      signatureAlgorithm: .ecdsaWithSHA512,
      validCombination: true
  ...
  @Test
  func `hash function mismatch p521 sha1 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p521Key),
      signatureAlgorithm: .sha1WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch p521 sha256 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p521Key),
      signatureAlgorithm: .sha256WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch p521 sha384 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p521Key),
      signatureAlgorithm: .sha384WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch p521 sha512 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p521Key),
      signatureAlgorithm: .sha512WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch p521 ed25519`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.p521Key),
      signatureAlgorithm: .ed25519,
      validCombination: false
  ...
  @Test
  func `hash function mismatch ed25519 ecdsa with sha256`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.ed25519Key),
      signatureAlgorithm: .ecdsaWithSHA256,
      validCombination: false
    )
  }
  ...
  @Test
  func `hash function mismatch ed25519 ecdsa with sha384`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.ed25519Key),
      signatureAlgorithm: .ecdsaWithSHA384,
      validCombination: false
  ...
  @Test
  func `hash function mismatch ed25519 ecdsa with sha512`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.ed25519Key),
      signatureAlgorithm: .ecdsaWithSHA512,
      validCombination: false
  ...
  @Test
  func `hash function mismatch ed25519 sha1 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.ed25519Key),
      signatureAlgorithm: .sha1WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch ed25519 sha256 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.ed25519Key),
      signatureAlgorithm: .sha256WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch ed25519 sha384 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.ed25519Key),
      signatureAlgorithm: .sha384WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch ed25519 sha512 with rsa encryption`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.ed25519Key),
      signatureAlgorithm: .sha512WithRSAEncryption,
      validCombination: false
  ...
  @Test
  func `hash function mismatch ed25519 ed25519`() throws {
    try self.hashFunctionMismatchTest(
      privateKey: .init(Fixtures.ed25519Key),
      signatureAlgorithm: .ed25519,
      validCombination: true
...
extension Certificate.Signature.Test.Integration {
  ...
  func `p384 signature validates over tbs certificate`() throws {
    ...
    let signature = try Certificate.Signature(
      signatureAlgorithm: .ecdsaWithSHA384,
      signatureBytes: ISO_8824.BitString(bytes: signatureBytes[...])
    )
    guard case .ecdsa(let sig) = signature.backing, let inner = P384.Signing.ECDSASignature(sig)
    else {
      Issue.record("Invalid signature decode")
      return
    }
    ...
    let issuingPublicKeyBytes: [UInt8] = [
      ...
      0x16, 0x4A, 0x3E, 0x5C, 0xCF, 0x77, 0xAC, 0xDE, 0x67, 0x05, 0x0D, 0x1D, 0x07, 0xB6, 0xDC,
      0x16,
      0xFB, 0x5A, 0x8B, 0x14, 0xDB, 0xE2, 0x71, 0x60, 0xC4, 0xBA, 0x45, 0x95, 0x11, 0x89, 0x8E,
      0xEA,
      0x06, 0xDF, 0xF7, 0x2A, 0x16, 0x1C, 0xA4, 0xB9, 0xC5, 0xC5, 0x32, 0xE0, 0x03, 0xE0, 0x1E,
      0x82,
      0x18, 0x38, 0x8B, 0xD7, 0x45, 0xD8, 0x0A, 0x6A, 0x6E, 0xE6, 0x00, 0x77, 0xFB, 0x02, 0x51,
      0x7D,
      0x22, 0xD8, 0x0A, 0x6E, 0x9A, 0x5B, 0x77, 0xDF, 0xF0, 0xFA, 0x41, 0xEC, 0x39, 0xDC, 0x75,
      0xCA,
      0x68, 0x07, 0x0C, 0x1F, 0xEA,
    ]
    let tbsCertificateBytes: [UInt8] = [
      0x30, 0x82, 0x02, 0x4D, 0xA0, 0x03, 0x02, 0x01, 0x02, 0x02, 0x11, 0x00,
      0xB3, 0xBD, 0xDF, 0xF8, 0xA7, 0x84, 0x5B, 0xBC, 0xE9, 0x03, 0xA0, 0x41, 0x35, 0xB3, 0x4A,
      0x45,
      0x30, 0x0A, 0x06, 0x08, 0x2A, 0x86, 0x48, 0xCE, 0x3D, 0x04, 0x03, 0x03, 0x30, 0x4F, 0x31,
      0x0B,
      0x30, 0x09, 0x06, 0x03, 0x55, 0x04, 0x06, 0x13, 0x02, 0x55, 0x53, 0x31, 0x29, 0x30, 0x27,
      0x06,
      ...
      ,
      ...
      ,
    ...
    #expect(publicKey.isValidSignature(inner, for: digest))

  }

  @Test
  func `signature validation ecdsa`() async throws {
    let algo = Certificate.SignatureAlgorithm.ecdsaWithSHA384

    func test(_ key: Certificate.PrivateKey) throws {
      let signature = try key.sign(bytes: Fixtures.dummyData, signatureAlgorithm: algo)
    ...
    try test(Certificate.PrivateKey(Fixtures.p256Key))
    try test(Certificate.PrivateKey(Fixtures.p384Key))
    try test(Certificate.PrivateKey(Fixtures.p521Key))
  }

  @Test
  func `signature validation eddsa`() async throws {
    let algo = Certificate.SignatureAlgorithm.ed25519
    let key = Certificate.PrivateKey(Fixtures.ed25519Key)
    let signature = try key.sign(bytes: Fixtures.dummyData, signatureAlgorithm: algo)
    let pub = key.publicKey
    let isValidSignature = pub.isValidSignature(
      signature.rawRepresentation,
  ...
  func `verify external signature ed25519`() throws {
    let publicKeyString = """
      ...
      """
    let b64Signature =
      "kxEmGeHhUT+dG4Kpq/+ZCMpHzbIfXb/Oss+mvAGJMoieCu+4dhsQaO/fKNBNUQmBj2wu0ZyHpkXX8p2Eijd/Aw=="
